...
export default function userSettingsLayout({ children }) {
  ...
  return (
    <div className="w-full h-full flex flex-col ">
      <nav className="flex items-center justify-center md:flex  md:items-center md:pl-32 py-10 w-full border-b-[2px] border-[#14b7a1] pt-[90px]  ">
        <ul className="flex  gap-6">
          <li className="flex flex-col gap-3">
            ...
            >
              ...
              <p className=" hidden md:flex"> Conta</p>
            </Link>
          </li>
          <li className="flex flex-col gap-3">
            <Link
            ...
            >
              ...
              <p className=" hidden md:flex">Pedidos</p>
            </Link>
          </li>
          <li className="flex flex-col gap-3">
            <Link
          ...
          <li className="flex flex-col gap-3">
            ...
            >
              ...
              <p className=" hidden md:flex"> Financeiro</p>
            </Link>
          </li>
        </ul>
      </nav>
