...
/*
 ...
 <div className="w-full flex flex-col items-center justify-center gap-1 text-white ">
              ...
              <h1 className="w-full text-white uppercase  text-4xl pl-2">
                {data?.name}
              </h1>
              <p className="w-full text-white text-sm  font-normal pl-2 ">
                {getDate(data?.date_event_initial, data?.date_event_end)}
              </p>

          
                <button className="w-[327px] h-[60px] bg-[#979797] flex items-center rounded-3xl text-white text-[20px] font-black  uppercase">
                  <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center ml-3 mr-8">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
              ...
              <div className="w-full flex-col md:flex md:flex-row  items-center pl-2">
                <div className="flex flex-col gap-4">
                  ...
                  <div className="flex gap-4 ">
                    <Facebook url={fullUrl} title={data?.name} />
                    <Whatsapp url={fullUrl} title={data?.name} />
                    <Twitter url={fullUrl} title={data?.name} />
                  </div>
                </div>
              </div>
            </div>
...
<div className="w-[50%] h-full flex  flex-col items-center justify-center gap-3 bg-red-500  ">
            <div className="w-full flex items-center justify-center gap-1 text-white pl-2">
          ...
          <div className="w-full flex md:hidden">
            {currentDate > new Date(Number(data?.date_event_end)) ? (
              ...
              <div className="w-full bg-[#d9d9d9] flex items-center justify-center py-2 h-14">
                <TimerComponent eventTimestamp={data?.date_event_initial} />
              </div>
            )}
          </div>
           ...
           <div className="hidden md:w-[50%] h-full md:flex  flex-col items-center   ">
          <img
            src={data?.cover}
            alt={data?.name}
            className="w-full md:w-[37%] h-full object-fill"
          />
          <div className="w-[37%] h-14 ">
            {currentDate > new Date(Number(data?.date_event_end)) ? (
              <div className="text-white w-full bg-red-600 flex items-center justify-center py-2 h-14">
                Encerrado
              </div>
