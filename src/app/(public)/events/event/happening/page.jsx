      ...
      <div className="max-w-[1140px] h-full mx-auto">
        <div className="w-full h-full mx-auto ">
          ...
          <div className="w-full flex flex-col gap-4">
            {
                eventNow && eventNow.length > 0 ?
                <GridLayout>
                { eventNow && eventNow.length > 0 && eventNow?.map((events, index) => (
                  <div
                    key={index}
                  ...
                  >
                    ...
                    <p className="w-full text-left">
                      {getDate(events.date_event_initial, events.date_event_end)}
                    </p>
                    <p>{events.city}</p>
                    ...
                    <div className="w-full flex items-center justify-center">
                      <Link
                        ...
                        className="w-full flex items-center justify-center bg-green-700 py-5 text-white "
                      >
                        <p>Rolando Agora</p>
                      </Link>
                    </div>
              ...
              <div className="w-full h-[50vh] flex items-center justify-center">
                <p className="text-gray-400">Nenhum evento rolando no momento!</p>
              </div>
            }
