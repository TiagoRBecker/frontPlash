...
import MenuMobile from "../Mobile/index.jsx";
...
const Header = () => {
  ...
  return (
    <header className={cls}>
      <div className="w-[50%] px-4 justify-start md:w-[30%]  h-full flex items-center md:justify-center gap-4">
        <Link
          href={"/"}
      ...
      <div className="w-[50%] flex items-center justify-end px-4 md:hidden">
        <div className="w-full  gap-5 flex items-center justify-end md:hidden">
          <div className="flex items-center w-full   justify-end cursor-pointer transiton duration-150  relative">
            <Link href={"/cart"}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
          ...
          <MenuMobile data={categories} status={status} />
        </div>
